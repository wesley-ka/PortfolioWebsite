    ...
    return Response.json(
      {
        ...
        message: 'No backend API is configured for this deployment. Using client-side simulation.',
      },
      { status: 404 }
    );
  }
    ...
    return Response.json(
      {
        ...
        message: error instanceof Error ? error.message : 'Failed to reach backend API',
      },
      { status: 502 }
    );
  }
